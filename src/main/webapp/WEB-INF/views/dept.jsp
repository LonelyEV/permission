        ...
        function recursiveRenderDept(deptList) {
            if(deptList && deptList.length > 0) {
                $(deptList).each(function (i, dept) {
                     ...
                     if (dept.departmentLevelList.length > 0) {
                         var rendered = Mustache.render(deptListTemplate, {deptList: dept.departmentLevelList});
                         $("#dept_" + dept.id).append(rendered);
                         recursiveRenderDept(dept.departmentLevelList);
                     }
                })
            }
        }
